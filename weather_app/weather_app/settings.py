...
DATABASES = {
    'default': dj_database_url.config(default='postgresql://wadb_9ggv_user:2VmjFl9TU1dZvuURuuWmEK9sG0LmuIlo@dpg-ct6s2t3qf0us738m0pa0-a/wadb_9ggv',        conn_max_age=600    )}

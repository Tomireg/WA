...
SECRET_KEY = 'django-insecure-&r9vu08mhh-n!j(57t26b1*ioyvo^21tnsq1urk%k(l5wi=uvs'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['wa-74im.onrender.com']
...
DATABASES = {
    'default': dj_database_url.config(default='postgresql://wadb_9ggv_user:2VmjFl9TU1dZvuURuuWmEK9sG0LmuIlo@dpg-ct6s2t3qf0us738m0pa0-a.frankfurt-postgres.render.com/wadb_9ggv',        conn_max_age=600    )}
